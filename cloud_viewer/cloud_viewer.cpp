...
int main(int argc, char **argv) {
    ...
    pcl::io::loadPCDFile("/home/yingyue/Desktop/PCL_Practice/data/tutorials/ism_test_cat.pcd", *cloud);

    pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_milk(new pcl::PointCloud<pcl::PointXYZRGB>);
    pcl::io::loadPCDFile("/home/yingyue/Desktop/PCL_Practice/data/tutorials/ism_test_cat.pcd", *cloud_milk);

    // 创建PCLVisualizer
    boost::shared_ptr<pcl::visualization::PCLVisualizer> viewer (new pcl::visualization::PCLVisualizer ("3D Viewer"));

    // 设置背景色为灰色（非必须）
    viewer->setBackgroundColor (255, 2555, 2555, 0);
...
// "/home/yingyue/Desktop/PCL_Practice/data/tutorials/ism_test_cat.pcd"